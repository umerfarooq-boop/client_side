...
=======
              className={`flex items-center justify-center px-3 h-8 leading-tight border ${link.active
                ? "z-10 text-indigo-600 border-indigo-300 bg-indigo-50 hover:bg-indigo-100 hover:text-indigo-700"
                : "text-gray-500 bg-white border-gray-300 hover:bg-gray-100 hover:text-gray-700"
                } rounded-${index === 0 ? "s-lg" : index === pagination.links.length - 1 ? "e-lg" : ""}`}
>>>>>>> 6ef1bc75752e89bb098cea7186676fa760692d1d
        ...
        <div>
          ...
          <div className="text-center mt-10 mb-10">
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
              Coach <span className="text-indigo-600">Posts</span>
            </h3>
          </div>
...
<<<<<<< HEAD
            posts.map((post, key) => (  
              <div
  key={key}
  className="bg-white shadow rounded-xl overflow-hidden grid grid-cols-1 md:grid-cols-5 gap-6 p-6 mt-10 items-center"
...
=======
                        ...
                        <div className="space-y-4">
                          <div
                            className={`transition-all duration-500 ease-in-out ${showReviews ? "max-h-auto opacity-100" : "max-h-0 opacity-0 overflow-hidden"
                              }`}
                          >
                            {playerReviews.map((review, index) => (
                              <div
...
<<<<<<< HEAD
  ...
  className="justify-center m-auto items-center flex text-black bg-indigo-600 hover:bg-indigo-700 rounded-md font-medium p-3 text-xl mt-24 transition"
>
  {loader ? (
    <Bars
      height="40"
...
=======
                <button
                  onClick={loadingEvent}
                  className="justify-center m-auto items-center flex text-white bg-indigo-600 hover:bg-indigo-700 rounded-md font-medium p-3 text-xl mt-6 transition"
                >
                  {loader ? (
                    <Bars
                      height="40"
...
//     try {
//       const apiKey =
//         "pk.eyJ1IjoidWlcndhbGkiLCJhIjoiY20ycGM0aWRrMGxmYjJtc2N2eWRvZHNpNiJ9._eLwWDk871QbnYrq8lcOkw";
//       const response = await axios.get(
//         `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(
//           location
//         )}.json?access_token=${apiKey}`
...
//         <div>
//           <Nav />
//           <div className="flex items-center justify-between flex-wrap mt-10 mb-10 px-4 sm:px-10">
...
//               <button
//                 onClick={loadingEvent}
//                 className="mt-4 sm:mt-0 text-white bg-indigo-600 hover:bg-indigo-700 px-5 py-2 text-sm font-medium rounded"
//               >
//                 Book Appointment
//               </button>
//             )}
...
//                   <div className="flex space-x-6 border-t pt-3 text-sm text-gray-600">
//                     <div className="flex items-center space-x-1">
...
//                     <div className="flex items-center space-x-1">
//                       <LocationOnSharpIcon fontSize="small" className="text-gray-500" />
//                       <span>{post.post_location?.split(",")[0] || "Location not available"}</span>
//                     </div>
//                   </div>
//                 </div>
...
//                       style={{ width: "100%", height: "100%" }}
//                       mapStyle="mapbox://styles/mapbox/streets-v11"
//                       mapboxAccessToken="pk.eyJ1IjoidWlcndhbGkiLCJhIjoiY20ycGM0aWRrMGxmYjJtc2N2eWRvZHNpNiJ9._eLwWDk871QbnYrq8lcOkw"
//                     >
//                       <Marker
//                         latitude={coordinates[post.id].latitude}
//                         longitude={coordinates[post.id].longitude}
