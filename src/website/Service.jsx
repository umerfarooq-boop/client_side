...
function Service() {
  return (
    <>
      <p className='text-center text-2xl font-medium mt-3'>Services</p>
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
        <div className="bg-gray-100 p-4 flex flex-col items-center">
          ...
          <p className="mt-2 text-lg font-semibold">Coach Management</p>
        </div>
        <div className="bg-gray-100 p-4 flex flex-col items-center">
          <SportsSoccerIcon style={{ fontSize: 60 }} className="text-green-500" />
          <p className="mt-2 text-lg font-semibold">Team Management</p>
        </div>
        <div className="bg-gray-100 p-4 flex flex-col items-center">
          <EventIcon style={{ fontSize: 60 }} className="text-yellow-500" />
          <p className="mt-2 text-lg font-semibold">Schedule & Booking</p>
        </div>
        <div className="bg-gray-100 p-4 flex flex-col items-center">
          <PaymentIcon style={{ fontSize: 60 }} className="text-red-500" />
          <p className="mt-2 text-lg font-semibold">Payments & Invoicing</p>
        </div>
      </div>
    </>
  );
