...
//             <iframe
//                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26573.60604664979!2d73.00049208429786!3d33.63900022166846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38df95b718e07973%3A0x51c83df388143239!2sI-11%2C%20Islamabad%2C%20Islamabad%20Capital%20Territory%2C%20Pakistan!5e0!3m2!1sen!2sus!4v1733383634173!5m2!1sen!2sus"
//                 width="100%"
//                 height="480"
//                 style={{ border: 0 }}
//                 allowFullScreen
...
//                     </form>
//                     </div>
//                     <div className="w-full shrink-0 m-auto grow-0 basis-auto lg:w-7/12">
//                     <div className="flex flex-wrap">
...
//                                 viewBox="0 0 111.756 122.879" enableBackground="new 0 0 111.756 122.879" xml-space="preserve">
//                                 <g>
//                                     <path
...
function Contact() {
  ...
  const addContactInfo = async (data) => {
    try {
      await axios.post('/feedbackform', data);
      Swal.fire({
        title: 'Success!',
  ...
  const realId = player_id && player_id !== 'undefined' ? player_id : coach_id;
    ...
    <>
      ...
      <section className="mb-32">
        ...
        <div className="container px-6 md:px-12 mx-auto">
          <div className="bg-gradient-to-br from-white/90 via-sky-50 to-white/90 border border-gray-200 backdrop-blur-xl rounded-xl shadow-2xl px-6 py-12 md:px-16 md:py-20 -mt-[120px] transition-all duration-500">
            {/* Header */}
            <div className="text-center mb-16">
              <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
                Send Us <span className="text-indigo-600">Message</span>
              </h3>
            </div>
            ...
            <div className="flex flex-wrap items-start justify-between gap-10">
              ...
              <div className="w-full lg:w-5/12">
                <form onSubmit={handleSubmit(addContactInfo)} className="space-y-6">
                  <input
                    type="text"
                    {...register('name', { required: true })}
                    className="w-full border-2 border-gray-200 focus:border-gray-600 focus:ring-2 focus:ring-gray-300 rounded-lg px-4 py-3 outline-none shadow-sm transition"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                  >
                    Send Message
                  </button>
                </form>
              ...
              <div className="w-full lg:w-6/12">
                <h3 className="text-2xl font-semibold text-gray-700 mb-8">Contact Information</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {/* Technical Support Section */}
                  <div className="flex items-start space-x-4">
                    <div className="bg-sky-100 p-3 rounded-full shadow-inner">
                      <svg
                      ...
                      >
                        {/* Correct Phone Icon */}
                        <path d="M21 15.5l-3.9-3.9c-.2-.2-.5-.3-.7-.3h-1.8c-.5 0-.9.4-.9.9 0 .2.1.4.3.6l1.3 1.3c-.5.7-.8 1.5-1.1 2.4-.3.9-.5 1.8-.6 2.7 0 .5-.4.9-.9.9H6.2c-.5 0-.9-.4-.9-.9-.1-.9-.3-1.8-.6-2.7-.3-.8-.6-1.7-1.1-2.4l1.3-1.3c.2-.2.3-.4.3-.6 0-.5-.4-.9-.9-.9H3.9c-.3 0-.5.1-.7.3L3 8.5c-.4.4-.5 1-.3 1.5.8 2.5 2.2 4.9 4.1 6.8 2.1 2.1 4.5 3.5 7.1 4.3.5.2 1.1.1 1.5-.3l3.5-3.5c.5-.5.5-1.3.1-1.7z" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-800">Technical Support</h4>
                      <p className="text-sm text-gray-600">coachselector@gmail.com</p>
                      <p className="text-sm text-gray-600">+92 3124567890</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="bg-sky-100 p-3 rounded-full shadow-inner">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                      >
                        {/* Correct Map Pin Icon */}
                        <path d="M12 2C8.1 2 5 5.1 5 8.5c0 2.8 1.5 5.1 3.8 6.6L12 21l3.2-5.9c2.3-1.5 3.8-3.8 3.8-6.6 0-3.4-3.1-6.5-7-6.5zm0 9c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-800">Address</h4>
                      <p className="text-sm text-gray-600">Pak-View City Islamabad</p>
                    </div>
                  </div>
                </div>
              </div>
