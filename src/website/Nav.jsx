  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="flex items-center gap-x-2 p-1 font-medium oswald-font"
      >
        <svg
          width="16"
          height="15"
      ...
      >
        ...
        <Link to={'/question'} className="flex items-center text-black">
          Question
        </Link>
      ...
      >
        ...
        <Link to={'/testimonial'} className="flex items-center text-black">
          Testimonial
        </Link>
      </Typography>
...

            {
              token ? (
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <Link
                    to="/login"
                    className="text-black oswald-font text-lg hidden lg:flex items-center gap-x-2"
                  >
                  ...
                  {/* Signup Button */}
                  {coach_id ? (
                    <h1 className="text-black oswald-font text-lg">Coach Info</h1>
                  ) : (
                    <Link
                      to="/signup"
                      onClick={handleClose}
                      className="text-black oswald-font text-lg hidden lg:flex items-center gap-x-1"
                    >
